...
public class BeanPropertyTest {
    ...
    public void testSimpleProperties() {
        BeanProperty<Automobile> painter = new BeanProperty<>(Automobile.class, "color", true, true);
        ...
        // primitive get
        BeanProperty<Automobile> transmission = new BeanProperty<>(Automobile.class, "automatic", true, false);
        ...
        BeanProperty<Truck> truckColor = new BeanProperty<>(Truck.class, "color", true, true);
        ...
        BeanProperty<Automobile> gasUp = new BeanProperty<>(Automobile.class, "fullOfGas", false, true);
        ...
        BeanProperty<Automobile> drivable = new BeanProperty<>(Automobile.class, "drivable", true, false);
        ...
        BeanProperty<SupportsTrailerHitch> towedVehicle = new BeanProperty<>(SupportsTrailerHitch.class, "towedVehicle", true, true);
    ...
    public void testNavigatedProperties() {
        // navigated get
        BeanProperty<SupportsTrailerHitch> towAndPaint = new BeanProperty<>(SupportsTrailerHitch.class, "towedVehicle.color", true, true);
        ...
        BeanProperty<SupportsTrailerHitch> red = new BeanProperty<>(SupportsTrailerHitch.class, "towedVehicle.color.red", true, false);
    ...
    public void testBadSetterMethod() {
        BeanProperty<Truck> painter = new BeanProperty<>(Truck.class, "towedVehicle.color", true, true);
    ...
    public void testThisProperty() {
        try {
            new BeanProperty<>(Truck.class, "this", true, true);
            fail("failed to throw an exception when creating a writable BeanProperty with 'this'");
        } catch (IllegalArgumentException e) {
            // expected
        }

        BeanProperty<Truck> identity = new BeanProperty<>(Truck.class, "this", true, false);
    ...
    public void testResolveGenericReturnType() {
        final BeanProperty<Bus> busPassengers = new BeanProperty<>(Bus.class, "passenger", true, true);
        assertSame(People.class, busPassengers.getValueClass());
    }

    @Test
    public void testResolveGenericParameterType() {
        final BeanProperty<Bus> busDriver = new BeanProperty<>(Bus.class, "driver", false, true);
    ...
    public void testInterfaces() {
        BeanProperty<SubInterface> codeProperty = new BeanProperty<>(SubInterface.class, "code", true, true);
